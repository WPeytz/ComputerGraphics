// WebGPU with depth buffer for shadow polygon culling
async function init() {
  ...
  // Create render pipeline with "greater" depth test (for shadows)
  ...
  function render() {
    ...
    // Create shadow projection matrix with small offset to avoid z-fighting
    const epsilon = 0.01; // Small offset
    ...
    // 2. Draw shadow polygons with shadow pipeline (greater depth test)
